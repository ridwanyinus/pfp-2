...
export const WobbleCard = ({ children, containerClassName, className }: { children: React.ReactNode; containerClassName?: string; className?: string }) => {
  ...
  return (
    <motion.section
      ...
      className={cn("mx-auto  bg-black-100  relative rounded-2xl overflow-hidden", containerClassName)}>
      <div
        ...
        <motion.div
          ...
          className={cn("h-full  flex flex-col  items-center xs:px-6 px-4 py-6 small:py-12 md:py-8 lg:py-12", className)}>
          {children}
        </motion.div>
      </div>
    </motion.section>
